...
source <(curl -fsSL https://raw.githubusercontent.com/erljef/ProxmoxVED/yamtrack/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/erljef/ProxmoxVED/yamtrack/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/erljef/ProxmoxVED/yamtrack/misc/tools.func) 2>/dev/null || {
