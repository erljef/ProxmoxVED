...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/erljef/ProxmoxVED/yamtrack/misc/api.func)
# Load Cloud-Init library for VM configuration
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/erljef/ProxmoxVED/yamtrack/misc/cloud-init.func) 2>/dev/null || true
